...
export class AsignacionEspecialidadTareaController {
  ...
  async create(
    @Body() createDto: CreateAsignacionEspecialidadTareaDto,
    @Request() req: any,
  ) {
  ...
  @ApiOperation({
    summary: 'Obtener todas las asignaciones de especialidad a tareas',
  })
  async findAll() {
  ...
  @ApiOperation({
    summary: 'Actualizar una asignación de especialidad a una tarea',
  })
  async update(
    @Param('id', ParseIntPipe) id: number,
    @Body() updateDto: UpdateAsignacionEspecialidadTareaDto,
    @Request() req: any,
  ) {
  ...
  @ApiOperation({
    summary: 'Eliminar una asignación de especialidad a una tarea',
  })

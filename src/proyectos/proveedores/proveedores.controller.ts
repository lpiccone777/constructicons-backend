import { 
  ...
  export class ProveedoresController {
    ...
    @ApiQuery({ name: 'categoria', required: false, description: 'Filtrar por categoría de proveedor' })
    ...
    async createContacto(
      ...
      return this.proveedoresService.createContacto(createContactoDto, req.user.id);
    }
    ...
    async updateContacto(
      ...
      return this.proveedoresService.updateContacto(id, updateContactoDto, req.user.id);
    }

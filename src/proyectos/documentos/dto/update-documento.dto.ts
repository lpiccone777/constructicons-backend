...
export class UpdateDocumentoDto {
  ...
  @ApiPropertyOptional({ 
    example: 'Versión actualizada del plano con modificaciones en área de cocina', 
  ...
  @ApiPropertyOptional({ 
    example: 'https://storage.constructicons.com/documentos/proyecto1/plano-pb-v2.pdf', 

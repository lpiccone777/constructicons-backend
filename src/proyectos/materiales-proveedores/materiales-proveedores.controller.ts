...
export class MaterialesProveedoresController {
  constructor(
    private readonly materialesProveedoresService: MaterialesProveedoresService,
  ) {}
  ...
  @UseGuards(PermissionsGuard)
  @ApiOperation({
    summary: 'Obtener comparativa de proveedores para un material',
  })
  async getComparativaProveedores(
  ...
  @UseGuards(PermissionsGuard)
  @ApiOperation({
    summary: 'Obtener una relación material-proveedor por su ID',
  })

...
export class AsignacionesController {
  ...
  async createProyectoAsignacion(
    ...
    return this.asignacionesService.createProyectoAsignacion(
      createDto,
      req.user.id,
    );
  }
  ...
  async updateProyectoAsignacion(
    ...
    return this.asignacionesService.updateProyectoAsignacion(
      id,
      updateDto,
      req.user.id,
    );
  ...
  async createTareaAsignacion(
    ...
    return this.asignacionesService.createTareaAsignacion(
      createDto,
      req.user.id,
    );
  }
  ...
  async updateTareaAsignacion(
    ...
    return this.asignacionesService.updateTareaAsignacion(
      id,
      updateDto,
      req.user.id,
    );
